...
public class ItemBean implements Serializable {
	...
	private Integer[] supplementaryItems;
    ...
    public void setId(Integer _id) {
  	...
  	public Integer[] getSupplementaryItems() {
  		return this.supplementaryItems;
  	}
  	
  	public void setSupplementaryItems(Integer[] supplementaryItems) {
  		this.supplementaryItems = supplementaryItems;
  	}
  	...
  	public Integer[] getDefaultCategories() {
  		return this.defaultCategories;
  	}
  	
  	public void setDefaultCategories(Integer[] defaultCategories) {
  		this.defaultCategories = defaultCategories;
  	}

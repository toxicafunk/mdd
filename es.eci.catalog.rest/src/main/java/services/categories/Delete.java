...
import static es.eci.catalog.model.Tables.CATEGORIES;
...
import es.eci.catalog.model.tables.records.CategoriesRecord;
...
public class Delete extends ECIServiceVerticle {
	...
	protected void executeService(UserTransaction ut, DSLContext create, Message<Object> message)
		...
		CategoriesRecord entityRecord = create.fetchOne(CATEGORIES, CATEGORIES._ID.eq(Integer.valueOf(idParameter)));

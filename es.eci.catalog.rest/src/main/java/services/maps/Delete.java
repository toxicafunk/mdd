...
import static es.eci.catalog.model.Tables.MAPS;
...
import es.eci.catalog.model.tables.records.MapsRecord;
...
public class Delete extends ECIServiceVerticle {
	...
	protected void executeService(UserTransaction ut, DSLContext create, Message<Object> message)
		...
		MapsRecord entityRecord = create.fetchOne(MAPS, MAPS._ID.eq(Integer.valueOf(idParameter)));

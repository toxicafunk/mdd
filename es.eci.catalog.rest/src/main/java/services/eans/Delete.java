...
import static es.eci.catalog.model.Tables.EANS;
...
import es.eci.catalog.model.tables.records.EansRecord;
...
public class Delete extends ECIServiceVerticle {
	...
	protected void executeService(UserTransaction ut, DSLContext create, Message<Object> message)
		...
		EansRecord entityRecord = create.fetchOne(EANS, EANS._ID.eq(Integer.valueOf(idParameter)));

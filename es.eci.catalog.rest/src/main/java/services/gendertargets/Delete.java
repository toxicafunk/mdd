...
import static es.eci.catalog.model.Tables.GENDER_TARGETS;
...
import es.eci.catalog.model.tables.records.GenderTargetsRecord;
...
public class Delete extends ECIServiceVerticle {
	...
	protected void executeService(UserTransaction ut, DSLContext create, Message<Object> message)
		...
		GenderTargetsRecord entityRecord = create.fetchOne(GENDER_TARGETS, GENDER_TARGETS._ID.eq(Integer.valueOf(idParameter)));

...
import static es.eci.catalog.model.Tables.VIDEOS;
...
import es.eci.catalog.model.tables.records.VideosRecord;
...
public class Delete extends ECIServiceVerticle {
	...
	protected void executeService(UserTransaction ut, DSLContext create, Message<Object> message)
		...
		VideosRecord entityRecord = create.fetchOne(VIDEOS, VIDEOS._ID.eq(Integer.valueOf(idParameter)));

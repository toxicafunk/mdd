...
import static es.eci.catalog.model.Tables.PRODUCT_TYPES;
...
import es.eci.catalog.model.tables.records.ProductTypesRecord;
...
public class Delete extends ECIServiceVerticle {
	...
	protected void executeService(UserTransaction ut, DSLContext create, Message<Object> message)
		...
		ProductTypesRecord entityRecord = create.fetchOne(PRODUCT_TYPES, PRODUCT_TYPES._ID.eq(Integer.valueOf(idParameter)));

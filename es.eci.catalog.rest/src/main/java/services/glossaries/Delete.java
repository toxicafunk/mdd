...
import static es.eci.catalog.model.Tables.GLOSSARIES;
...
import es.eci.catalog.model.tables.records.GlossariesRecord;
...
public class Delete extends ECIServiceVerticle {
	...
	protected void executeService(UserTransaction ut, DSLContext create, Message<Object> message)
		...
		GlossariesRecord entityRecord = create.fetchOne(GLOSSARIES, GLOSSARIES._ID.eq(Integer.valueOf(idParameter)));

...
import static es.eci.catalog.model.Tables.RELATED_ITEMS;
...
import es.eci.catalog.model.tables.records.RelatedItemsRecord;
...
public class Delete extends ECIServiceVerticle {
	...
	protected void executeService(UserTransaction ut, DSLContext create, Message<Object> message)
		...
		RelatedItemsRecord entityRecord = create.fetchOne(RELATED_ITEMS, RELATED_ITEMS._ID.eq(Integer.valueOf(idParameter)));

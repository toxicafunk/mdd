...
import static es.eci.catalog.model.Tables.SUPPLIERS;
...
public class Delete extends ECIServiceVerticle {
	...
	protected void executeService(UserTransaction ut, DSLContext create, Message<Object> message)
		...
		SuppliersRecord entityRecord = create.fetchOne(SUPPLIERS, SUPPLIERS._ID.eq(Integer.valueOf(idParameter)));

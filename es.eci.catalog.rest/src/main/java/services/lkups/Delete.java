...
import static es.eci.catalog.model.Tables.LKUPS;
...
import es.eci.catalog.model.tables.records.LkupsRecord;
...
public class Delete extends ECIServiceVerticle {
	...
	protected void executeService(UserTransaction ut, DSLContext create, Message<Object> message)
		...
		LkupsRecord entityRecord = create.fetchOne(LKUPS, LKUPS._ID.eq(Integer.valueOf(idParameter)));

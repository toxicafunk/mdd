...
import static es.eci.catalog.model.Tables.LINKS;
...
import es.eci.catalog.model.tables.records.LinksRecord;
...
public class Delete extends ECIServiceVerticle {
	...
	protected void executeService(UserTransaction ut, DSLContext create, Message<Object> message)
		...
		LinksRecord entityRecord = create.fetchOne(LINKS, LINKS._ID.eq(Integer.valueOf(idParameter)));

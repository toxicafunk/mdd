...
import static es.eci.catalog.model.Tables.IMAGES;
...
import es.eci.catalog.model.tables.records.ImagesRecord;
...
public class Delete extends ECIServiceVerticle {
	...
	protected void executeService(UserTransaction ut, DSLContext create, Message<Object> message)
		...
		ImagesRecord entityRecord = create.fetchOne(IMAGES, IMAGES._ID.eq(Integer.valueOf(idParameter)));
